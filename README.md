...
```python
from quintus import Quintus, ProviderEngines

quintus = Quintus()

quintus.scrape().injest().chat(ProviderEngines.OPEN_AI)
```
...
quintus.add_local_model("llama-7b", "llama-7b-ft").chat(ProviderEngines.LOCAL)
```
